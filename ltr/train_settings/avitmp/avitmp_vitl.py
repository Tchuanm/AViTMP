...
def run(settings):
    settings.description = 'avitmp_vitl'
    ...
    settings.num_encoder_layers = 24
    ...
    net = avitmpnet.avitmpnet_l(filter_size=settings.target_filter_sz, backbone_pretrained=True, head_feat_blocks=0,
