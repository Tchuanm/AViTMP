...
def create_default_local_file():
    ...
    ltr_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../'))
    empty_str = '\'\''
    default_settings = OrderedDict({
        ...
        'lasot_dir': 'self.workspace_dir + \'/../data/lasot\'',
        'got10k_dir': 'self.workspace_dir + \'/../data/got10k/train\'',
        'trackingnet_dir': 'self.workspace_dir + \'/../data/trackingnet\'',
        'coco_dir': 'self.workspace_dir + \'/../data/coco\'',
        'lvis_dir': empty_str,
        'sbd_dir': empty_str,
