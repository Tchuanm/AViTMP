...
def parameters():
    ...
    params.init_samples_minimum_weight = 0.0 # 0.25
    ...
    params.use_clipped_window = True      # clip or not
    ...
    params.net = NetWithBackbone(net_path='avitmp.pth.tar', use_gpu=params.use_gpu)
