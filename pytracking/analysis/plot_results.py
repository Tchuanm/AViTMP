...
def plot_results(trackers, dataset, report_name, merge_results=False,
    ...
    if 'success' in plot_types:
        ...
        each_video_suc = ave_success_rate_plot_overlap.mean(-1).flatten()
        print("AUC of each video: ", each_video_suc)
        print("AUC: %.2f" % auc.item())
