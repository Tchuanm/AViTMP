...
def run_sequence(seq: Sequence, tracker: Tracker, debug=False, visdom_info=None, num_gpu=1):
...
def run_dataset(dataset, trackers, debug=False, threads=0, visdom_info=None, num_gpus=1):
